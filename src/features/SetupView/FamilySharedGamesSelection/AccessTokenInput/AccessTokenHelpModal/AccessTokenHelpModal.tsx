...
const AccessTokenHelpModal = (props: {
	isOpen: boolean;
				...
				<div className="flex flex-col gap-4 text-gray-300">
					...
					<div className="flex flex-col gap-3">
						<div>
							<p className="font-semibold text-gray-200 mb-2">
								1. Make sure you're signed in to Steam
							</p>
							<p className="text-sm text-gray-400">
								Open your browser and ensure you're logged in to your Steam
								account at{" "}
								<a
						...
						<div>
							...
							<p className="text-sm text-gray-400">
								Copy the{" "}
								<span className="font-semibold">entire JSON response</span> or
								just the <Kbd>webapi_token</Kbd> value and paste it into the
								input field. Both formats are accepted.
							</p>
						</div>
					</div>
					...
					<div className="bg-yellow-900/20 border border-yellow-700/30 p-3 rounded mt-2">
						...
						<p className="text-yellow-100/90 text-sm">
							This token gives access to your Steam account. Never share it with
							anyone you don't trust. This application only uses it to access
							your family shared games list.
						</p>
					</div>
				</div>
			</DialogContent>
