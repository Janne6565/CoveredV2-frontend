    ...
    <Dialog open={props.isOpen} onOpenChange={props.setOpen}>
      ...
      >
        ...
        <div>
          ...
          <Image src={image1} alt={"Click on your profile in the top right"}
                 openFullScreenModal={openFullScreenModal} />
          <Text>2. Click on <Kbd>View my profile</Kbd></Text>
          <Image src={image2} alt={"Click on 'View my profile'"} openFullScreenModal={openFullScreenModal} />
          <Text>3. Click on the URL in the top left to copy your profile url</Text>
          <Text className="text-gray-500 !mt-0">The format can either be: https://steamcommunity.com/id/_jannox/ or
            https://steamcommunity.com/profiles/76561198419165332</Text>
          <Image src={image3} alt={"Click on the URL in the top left to copy your profile url"}
                 openFullScreenModal={openFullScreenModal} />
        </div>
      </DialogContent>
    </Dialog>
    <ImageModal open={!!openImage} src={openImage ?? ""} setOpen={() => setOpenImage(null)} imageAlt={openAlt ?? ""} />
  </>;
};
