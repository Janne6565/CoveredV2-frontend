...
const SetupView = (props: { visible: boolean }) => {
	...
	return (
		...
		>
			...
			<div className="flex flex-col items-center justify-center text-center space-y-5 mt-4 absolute translate-x-[-50%] left-[50%] family-shared-games-selection-container opacity-0 max-w-[80vw] w-[500px]">
