...
export const Layout = ({ children, mode }: LayoutProps) => {
  return (
    <div
      className="w-full h-full min-h-screen flex items-center justify-center text-white dark overflow-x-hidden"
      style={{
        background:
    ...
    >
      <div className="flex flex-col items-center justify-center h-fit px-4 max-w-full">
        <div className="flex flex-row items-center justify-center text-center space-x-5 max-w-full">
