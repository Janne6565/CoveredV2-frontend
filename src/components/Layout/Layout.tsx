	...
	return (
		...
		>
			<div className="flex flex-col items-center justify-center h-fit px-4 max-w-full">
				<div className="flex flex-col md:flex-row gap-y-5 md:gap-y-0 items-center justify-center text-center space-x-5 max-w-full py-[30px] lg:pt-[100px]">
				...
				<div
					className={
						"relative lg:hidden text-gray-500 text-xl py-[50px] pb-[100px] text-center w-[70%]"
					}
				>
